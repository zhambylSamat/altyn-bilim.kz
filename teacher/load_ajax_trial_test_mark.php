<?php
	...
	try {
		...
		foreach ($trial_test_sql_result as $key => $value) {
			if ($date_of_test_max=="") {
				$date_of_test_max = $value['date_of_test_max'];
			}
...
<form method='post' id='trial_test_form' style='display: none;'>
	<div class='form-group'>
		...
		<input type="date" class='form-control' placeholder="dd.mm.yyyy" min="<?php echo $date_of_test_max; ?>" id='trial-date' name="trial_date" required="" style='display:inline-block; width: 50%;'>
	</div>
	<div class='form-group'>
