...
include('../connection.php');
	...
	else if(!isset($_SESSION['parent_phone'])){
	...
	<div class='container'>
		<div class='row'>
			<div class='col-md-12 col-sm-12' id='month'>
				<center>
					<h3 style='color:#555;'>
						Студент: <i><?php echo $student_info['name']." ".$student_info['surname'];?></i>
					</h3>
					<hr>
					<div>
						<h4>
							...
							<?php 
								...
								foreach($subjects as $value){	
									...
									$count++;
									echo "<a data-gin=".$value['group_info_num']." data-sn=".$value['subject_num']." class='month btn btn-sm ".$class."' href='#".$value['group_name']."'><b>".$value['name']."</b></a>&nbsp;";
								} 
							?>
						</h4>
					</div>
