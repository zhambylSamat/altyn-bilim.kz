		...
		<div style="padding:3%;">
			<span class='pull-right'>
				...
				<span class='pull-right' style='width: 100%;'>
					<select class='form-control trial_test_select_search_subject'>
					...
					<select class='form-control trial_test_select_search_school'>
						<option value=''>Барлығы</option>
						<?php
					...
					<select class='form-control trial_test_search_order_type'>
						<option value='<?php echo $avg;?>'>Оқушының орташа баллы бойынша</option>
