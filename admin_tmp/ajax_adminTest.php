 <?php
	...
	if(isset($_GET[md5('elementNum')])){
		...
		try {
			$stmt = $conn->prepare("INSERT IGNORE INTO test (test_num, subtopic_num) VALUES(:test_num, :subtopic_num) ");
	 	...
	 	// include_once('ajax_controller_test.php');
	 	// include_once('ajaxDb.php');
	}
	else{
		...
		<form method='post' class='add-test-form' enctype="multipart/form-data"> <!-- ajaxDbTest.php -->
			<div class='row'>
				<div class='form-group col-md-12 col-sm-12'>
					...
					<!-- <input type="text" class='form-control disabledd' name="question-txt" id='question' value='<?php echo $readrow_question['question_text'];?>' placeholder="'Сұрақты' белгілеңіз"> -->
					...
					<div class='upload-img-body'>
						...
						<?php }?>
						<!-- <label id='question-img-label-<?php echo $readrow_question['question_num'];?>' for='question-img-<?php echo $readrow_question['question_num'];?>' class='img-upload-style'> -->
						...
						<!-- <input type="file" class='disabledd' name="question-img" onchange="uploadImg('#question-img-<?php echo $readrow_question['question_num'];?>','#question-img-label')" id='question-img-<?php echo $readrow_question['question_num'];?>'> -->
				...
				<div class='form-group answer'>
					<div class='col-md-6 col-sm-6 answer-content'>
						...
						<div class='col-md-10 col-sm-10 upload-img-body'>
							...
							<div class='cover hidden' onclick='removeFile("#answer-img-<?php echo $readrow_answer['answer_num'];?>")' class='delete'><center>Delete</center></div>
							<div class='img-big'><center>Увеличить</center></div>
							...
							<?php }?>
							<label id='answer-img-label-<?php echo $readrow_answer['answer_num'];?>' for='answer-img-<?php echo $readrow_answer['answer_num'];?>' class='img-upload-style'>
								<center>
									<?php
							...
							<input type="file" class='disabledd' name="answer_img[<?php echo $count_answer;?>]" onchange="uploadImg('#answer-img-<?php echo $readrow_answer['answer_num'];?>','#answer-img-label-<?php echo $readrow_answer['answer_num'];?>')" id='answer-img-<?php echo $readrow_answer['answer_num'];?>'>
						</div>
					</div>
				</div>
				<?php $count_answer++;}?>
			...
			<div class='row'>
				<div class='form-group col-md-12 col-sm-12'>
					...
					<div class='upload-img-body'>
						...
						<!-- <input type="file" name="question-img" onchange="uploadImg('#question-img','#question-img-label')" id='question-img'> -->
		...
		<form>
			<div class='row'>
				<div class='form-group col-md-12 col-sm-12'>
					...
					<input type="text" class='form-control disabledd' name="question-txt" id='question' placeholder="'Сұрақты' белгілеңіз">
					<br>
					<div class='upload-img-body'>
						...
						<input type="file" class='disabledd' name="question_img" onchange="uploadImg('#question-img','#question-img-label')" id='question-img'>
					</div>
					<br><br>
				</div>
				<div class='form-group answer' id='id-0'>
					<div class='col-md-6 col-sm-6 answer-content'>
						<div class='col-md-10 col-sm-10'>
							<input type="text" name="answer[0]" class='form-control disabledd' placeholder="Жауапты белгілеңіз">	
						</div>
						<div class='col-md-2 col-sm-2'>
							<center><input type="checkbox" class='disabledd' checked name="torf[0]" value='1'></center>
						</div>
						<br>
						<div class='col-md-10 col-sm-10 upload-img-body'>
							...
							<input type="file" class='disabledd' name="answer_img[0]" onchange="uploadImg('#answer-img-0','#answer-img-label-0')" id='answer-img-0'>
						</div>
					</div>
				</div>
				<div class='form-group answer' id='id-1'>
					<div class='col-md-6 col-sm-6 answer-content'>
						<div class='col-md-10 col-sm-10'>
							<input type="text" name="answer[1]" class='form-control disabledd' placeholder="Жауапты белгілеңіз">
						</div>
						<div class='col-md-2 col-sm-2'>
							<center><input type="checkbox" class='disabledd' name="torf[1]" value='1'></center>
						</div>
						<br>
						<div class='col-md-10 col-sm-10 upload-img-body'>
							...
							<input type="file" class='disabledd' name="answer_img[1]" onchange="uploadImg('#answer-img-1','#answer-img-label-1')" id='answer-img-1'>
						</div>
					</div>
				</div>
				...
				<div class='form-group answer' id='id-100'>
					<div class='col-md-6 col-sm-6 answer-content'>
						...
						<div class='col-md-2 col-sm-2'>
							<center>
								<input type="checkbox" class='disabledd' name="torf[1]" value='1'>
