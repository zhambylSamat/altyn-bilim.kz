	...
	<form class='student-form form-horizontal'>
		...
		<div class='form-group col-md-6 col-sm-6 col-xs-12'>
			...
			<div class='row'>
				...
				<div class='col-md-8 col-sm-8 col-xs-8'>
					<input type="text" name="student_username" id='student-username' class='form-control check-for-existing check-required' autocomplete="off" placeholder="name.surname" required="" <?php echo $action=="view" ? "disabled" : "";?> value='<?php echo $view ? $result['username'] : "" ?>'>
		...
		<div class='form-group col-md-6 col-sm-6 col-xs-12' style='border: 1px solid #ccc; padding-top:1%; padding-bottom:1%; border-radius: 10px;'>
			...
			<div class='row'>
				...
				<div class='col-md-8 col-sm-8 col-xs-8'>
					<div class='input-group'>
						<div class="input-group-addon">+7</div>
						<input type="number" name="parent_phone_1" class='form-control check-for-existing' max='7999999999' min='7000000000' id='parent-phone-1' placeholder="7071234455" <?php echo $action=="view" ? "disabled" : "";?> value='<?php echo $view ? $result['p1Phone'] : "" ?>' autocomplete="off">
					</div>
		...
		<div class='form-group col-md-6 col-sm-6 col-xs-12'>
			...
			<div class='row'>
				...
				<div class='col-md-8 col-sm-8 col-xs-8'>
					<div class='input-group'>
						<div class="input-group-addon">+7</div>
						<input type="number" name="parent_phone_2" class='form-control check-for-existing' max='7999999999' min='7000000000' id='parent-phone-2' placeholder="7071234455" <?php echo $action=="view" ? "disabled" : "";?> value='<?php echo $view ? $result['p2Phone'] : "" ?>' autocomplete="off">
					</div>
