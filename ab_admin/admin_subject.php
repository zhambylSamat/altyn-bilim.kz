	...
	<form class='form-inline create_subject' method='post' action="admin_controller.php" novalidate>
		<div class='form-group'>
			<div class='topic-input'>
				...
				<p class="help-block">Аралық бақылау енгізу үшін тақырып деген жерге "бақылау" деп жазу керек.</p>
			</div>
...
<a class='btn pull-right' data-toggle='modal' data-target='#config-box'><u>Конфигурация</u></a>
