				...
				<div class='col-md-3 col-sm-3'>
					<div class='btn-group-vertical' style='width:100%;'>
						...
						<div class='btn-group' role='group' target_name='<?php echo $content_name[$topic_key];?>'>
							<button id='btn-dropdown-1' type='button' class='btn btn-primary dropdown-toggle tooltp' data-toggle='dropdown' title='<?php echo $content_name[$topic_key];?>' aria-haspopup='true' aria-expanded='true'>
								<?php echo substr($content_name[$topic_key],0,35).((strlen($content_name[$topic_key])>35) ? "..." : "");?>
							...
							<ul class='dropdown-menu' aria-labelledby='btn-dropdown-1' style="width:100%;">
								...
								?>
								<li>
									<a title='<?php echo $content_name[$subtopic_key];?>' target_name='<?php echo $content_name[$subtopic_key];?>' data_name='subtopic' data_num='<?php echo $subtopic_key;?>' class='section' style='cursor:pointer;'><span class='glyphicon glyphicon-triangle-right'></span>&nbsp;<?php echo substr($content_name[$subtopic_key],0,35).((strlen($content_name[$subtopic_key])>35) ? "..." : "");?></a>
								</li>
								<?php }} ?>
							</ul>
						</div>
