		...
		<div class='row'>
			...
			<div class='col-md-12 col-sm-12 col-xs-12'>
				<div class='marks box'>
					...
					<div class='outer'>
						<div class='inner mark-info' style='border-right: 2px solid gray;'>
							<?php
								try {
...
// --------------------------------
		    	...
		    	if(data.success){
		    		...
		    		if(data.text=="noVideo"){
		    			...
		    			$thisParent.css({'background-color':"#FFB800"}).animate({backgroundColor: 'rgba(255, 255, 255, 0)'},3000,function(){
		    				$thisParent.find("b").slideUp(1000,function(){$(this).remove()});
		    			});
		    		}
		    	}
		    	else{
	...
	$(document).on('click','.list-progress',function(){
		$sn = $(this).parents('.head-student').find('.header-student').attr("data-num");
