			...
			<div class='row' style='padding: 0px 20px;'>
				<div class='short_info std-info'>
					<div class='col-md-6 col-sm-6 col-xs-12'>
						...
						&nbsp;&nbsp;
						<a href='<?php echo $ab_root."/academy/staff/student/student_cabinet?student_id=".$student_id; ?>' target='_blank' class='cursor-pointer'><?php echo $value['full_name'].'  '.$value['phone']; ?></a>
									...
									<li style='border: 1px solid lightgray; padding: 5px 0px 5px 10px; list-style-position: inside;'>
										...
										<?php
											...
											if ($val['status'] == 'inactive') {
												...
												$html .= "<span class='tmp' style='margin-left: 10px;'>";
