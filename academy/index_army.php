...
<head>
	...
	<link rel="stylesheet" type="text/less" href="lending_style/style.less?v=0.3.9">
		...
		<div class='col-md-6 col-sm-6 col-xs-12'>
			<div id='black-sheet-cover'>
				...
				<div id='welcome-content'>
					...
					<br>
					<span id='head-title'>ҰБТ-ға ОНЛАЙН ДАЙЫНДЫҚ АКАДЕМИЯСЫ</span>
					<br>
					<center>
						<table class='table'>
							<tr>
		...
		<div class='col-md-6 col-sm-6 col-xs-12'>
			...
			<center>
				<table id='top-advantages'>
					...
					<tr>
						<td class='dot-list'><img src="lending_img/dot_blue.png"></td>
						<td class='head-list-content'><span class='head-list-text head-list-text-blue'>Оқушымен үнемі байланыс </span></td>
					...
					<tr>
						<td class='head-list-btn' colspan='2'>
							<center>
								<button onclick="window.location.href='https://wa.me/77773890099?text=Саламатсыз%20ба.%20Altyn%20Bilim%20Онлайн%20академиясына%20курсқа%20жазылайын%20деп%20едім.'" class='btn-block btn-yellow pulse-yellow'>КУРСҚА ТІРКЕЛУ</button>
						...
						<td class='head-list-btn' colspan='2'>
							<center>
								<button class='btn-block btn-red-border' id='welcome-video-btn' data-url='https://vimeo.com/468130293'>
									<table>
										<tr>
											<td id='play-btn-icon'><span class='glyphicon glyphicon-play-circle'></span></td>
											<td id='play-btn-text'>Курс туралы видео ақпарат 4 минутта</td>
										</tr>
									</table>
								</button>
							</center>
		...
		<div class='row'>
			<div class='col-md-12 col-sm-12 col-xs-12'>
				<center>
					...
					<p id='section-2-description'>
						Онлайн курстарда әдетте басты проблема - оқушылардың мотивациясының және дисциплинасының жетіспеушілігі. Осы мәселені шешу үшін біз ҰБТ-ға онлайн дайындыққа арналған <br><b id='army-title'>"АРМИЯ"</b><br> курсын құрастырдық. 
					</p>
			...
			<div class='col-md-12 col-sm-12 col-xs-12'>
				<div id='step-1' class='lesson-step'>
					<div class='row'>
						...
						<div class='col-md-7 col-sm-8 col-xs-12'>
							<p class='step-title'>Тақырыпты көріп, тапсырмаларды орында</p>
							<p class='step-subtitle'>
								&nbsp;&nbsp;Аптасына 6 күн сабақ оқимыз. Оның үшеуінде оқушы біздің арнайы дайындаған оқу платформамызда жаңа тақырып өтеді, ал қалған үшеуінде мұғаліммен тікелей эфирге шығады. Жаңа сабақ барысында тақырыптың түсіндірілуі, есептері және олардың шығарылу жолдары толық 100% қамтылады.
								<br>
								&nbsp;&nbsp;Сабақтың аяғында оқушының түсінгенін тексеру үшін тақырып бойынша тест есептері беріледі.
							</p>
						</div>
					</div>
				</div>
				...
				<div id='step-2' class='lesson-step'>
					<div class='row'>
						...
						<div class='col-md-7 col-sm-8 col-xs-12'>
							<p class='step-title'>Жазған конспектіңді және шығарған есептеріңді жүкте</p>
							<p class='step-subtitle'>
								&nbsp;&nbsp;Тақырыпты көріп, есептерді шығарып болған соң оқушы өзінің жазған конспектісін және шығарған есептерінің фотосын оқу платформамызға жүктейді. Осы арқылы біз оқушының оқуын қадағалап, қатесін дұрыстап, дұрыс нұсқау береміз.
								<!-- <br>
								&nbsp;&nbsp;&nbsp;Мотивация беру мақсатында тапсырмаларды толық орындап, тесттерден жоғарғы бал жинап жүрген оқушыларға "медальдар" мен "монеталар" беріледі. Кейін бұларды тегін оқу күндеріне ауыстырса болады. -->
							</p>
						</div>
					</div>
				</div>
				...
				<div id='step-3' class='lesson-step'>
					<div class='row'>
						...
						<div class='col-md-7 col-sm-8 col-xs-12'>
							<p class='step-title'>Тікелей эфирге қосыл</p>
							<p class='step-subtitle'>
								&nbsp;&nbsp;Жаңа сабақтан кейін келесі күндері біз оқушылармен ZOOM платформасы арқылы ТІКЕЛЕЙ ЭФИРГЕ шығамыз. Ол жерде оқушылардың тақырып бойынша сұрақтарына жауап береміз және шықпаған есептерін талдаймыз.
								<br>
								&nbsp;&nbsp;Бұған қоса, 2020 жылғы ҰБТ базасының жаңа варианттарын талдаймыз. Осы арқылы оқушы тақырыпты толық 100% қамтып, тест есептерімен жұмысты бірден бастайды
							</p>
						</div>
					</div>
				</div>
	...
	<div class='container'>
		<div class='row'>
			<div class='col-md-8 col-md-offset-2 col-sm-12 col-xs-12'>
				<center><p id='section-3-title'>Сен  ЕҢ білікті, ҰБТ-да тәжірибелері мол мұғалімдермен шұғылданатын боласың</p></center>
			</div>
		...
		<div class='row'>
			<div class='col-md-12 col-sm-12 col-xs-12'>
				<p id='section-4-title'>
					<span class='section-4-title-blue'>ALTYN BILIM Онлайн Академиясында</span> оқу басқа мектептермен салыстырғанда <span class='section-4-title-yellow'>3 есе,</span> ал репетитормен айналысқаннан <span class='section-4-title-yellow'>5 есе арзан</span> және:
				</p>
			</div>
			<div class='col-md-4 col-sm-4 hidden-xs'>
				<div id='section-4-target'>
					<center><p id='section-4-price-subtitle' style='margin: 0;'>Әр пәнге</p></center>
					<center><p id='section-4-price-title'>9 990тг</p></center>
					<!-- <center><p id='section-4-price-subtitle'>*алғашқы аптасы ТЕГІН </p></center> -->
					<center><button onclick="window.location.href='https://wa.me/77773890099?text=Саламатсыз%20ба.%20Altyn%20Bilim%20Онлайн%20академиясына%20курсқа%20жазылайын%20деп%20едім.'" id='section-4-register-btn' class='pulse-yellow'>ТІРКЕЛУ </button></center>
				</div>
			</div>
				...
				<div id='section-4-list-box'>
					<table>
						<tr class='section-4-list'>
							...
							<td class='section-4-text'>Мұғаліммен <span class='section-4-text-yellow'>үнемі</span> байланыста боласың</td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'><span class='section-4-text-blue'>Тікелей эфирлер</span> арқылы түсінбеген сұрақтарыңа жауап аласың</td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'>Әр тақырып <span class='section-4-text-yellow'>100%</span> қамтылады</td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'><span class='section-4-text-blue'>Сапалы</span> оқу материалдарымызбен оқисың</td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'>Тақырыпты <span class='section-4-text-yellow'>фундаменталды</span> меңгересің, жаттанды емес</td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'>Мұғалім оқуыңды қадағалап, оқуыңа <span class='section-4-text-blue'>дұрыс нұсқау</span> береді</td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'>Мотивациялық видеолармен оқушыларды <span class='section-4-text-yellow'>жігерлендіреміз</span></td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'>Оқу барысында <span class='section-4-text-blue'>бонустар жинап</span>, айдың аяғында <span class='section-4-text-yellow'>жеңілдіктерге</span> айырбастайсың</td>
						</tr>
						<tr class='section-4-list'>
							<td class='section-4-thick'><img src="lending_img/tick.png"></td>
							<td class='section-4-text'><span class='section-4-text-blue'>2020 ҰБТ</span> базасының жаңа варианттарын талдаймыз</td>
						</tr>
					</table>
				</div>
			</div>
			<div class='hidden-lg hidden-md hidden-sm col-xs-12'>
				<div id='section-4-target-mobile'>
					<center><p id='section-4-price-subtitle' style='margin: 0;'>Әр пәнге</p></center>
					<center><p id='section-4-price-title-mobile'>9 990тг</p></center>
					<!-- <center><p id='section-4-price-subtitle-mobile'>*алғашқы сабақ ТЕГІН </p></center> -->
					<center><button onclick="window.location.href='https://wa.me/77773890099?text=Саламатсыз%20ба.%20Altyn%20Bilim%20Онлайн%20академиясына%20курсқа%20жазылайын%20деп%20едім.'" id='section-4-register-btn-mobile' class='pulse-orange'>ТІРКЕЛУ </button></center>
	...
	<div class='container'>
			...
			<div class='faq-topics faq-middle'>
				...
				<div class='faq-content' style='display: none'>
					<div class='parent-faq' data-num='9'>
						<div class='parent-faq-question'>
							<span>9 990 тг бір пәнге ма?</span>
						</div>
						<div class='parent-faq-answer' style='display: none'>
							<p class='indent'></p>Иә, 9 990 тг – бір пәннің бір айға төлемі. Оқу барысында төлемді ай сайын жасап тұрсаңыз болады немесе бірден бірнеше айға төлесеңіз болады.
						</div>
					</div>
					<div class='parent-faq' data-num='10'>
						...
						<div class='parent-faq-answer' style='display: none'>
							<p class='indent'></p>Біздің курсқа досыңды шақырсаң (промокод бойынша), саған бір айға 20% жеңілдік беріледі. Екі досыңды шақырсаң, 40% жеңілдік беріледі, т.с.с. Демек, 5 досың сенің промокодың бойынша тіркелсе, толық 1 ай тегін оқисың.
						</div>
					</div>
				</div>
			</div>
			...
			<div class='faq-topics faq-bottom'>
				...
				<div class='faq-content' style='display: none'>
					...
					<div class='parent-faq' data-num='12'>
						...
						<div class='parent-faq-answer' style='display: none'>
							<p class='indent'></p>Курсымызға тіркелген соң біз сізді Whatsapp-тағы жабық группамызға қосамыз. Ол жерде біз оқушылармен үнемі байланыста болып, тапсырма береміз, оқуларын қадағалаймыз және оқуға мотивация беріп отырамыз.
							<br>
							<p class='indent'></p>Бұған қоса, сізге автоматты түрде SMS хабарландырулар жіберіледі.
						</div>
					</div>
		...
		<div class='col-md-6 col-sm-6 hidden-xs'>
			...
			<div class='parent-faq-appropriate-img' data-num='9' style='display: none;'>
				<center><img src="lending_img/price_v_1.png"></center>
			</div>
	...
	<div class='container'>
		<div class='row'>
			...
			<div class='col-md-12 col-sm-12 col-xs-12' id='section-12-content'>
				...
				<center><button onclick="window.location.href='https://wa.me/77773890099?text=Саламатсыз%20ба.%20Altyn%20Bilim%20Онлайн%20академиясына%20курсқа%20жазылайын%20деп%20едім.'" id='section-12-btn'>Біздің курсқа тіркел</button></center>
...
?>
<script type="text/javascript" src='script.js?v=1.1.0'></script>
