...
<?php
	if(!isset($_SESSION['default_student_num'])){
	...
	<div class='row'>
		<div class='col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4'>
			<div style='margin-top:40%;'>
				<h5><b>Здравствуйте, <?php echo $_SESSION['student_name'].' '.$_SESSION['student_surname'].'.';?></b></h5>
				<h5>Вам следует поменять пароль с "AltynBilim" на любой другой, чтобы зайти в систему.</h5>
				<p>*Важно: Ваш пароль должен содержать не менее 5 символов!</p>
				<center>
...
<script type="text/javascript">
	$(document).on('submit','form',function(e){
		...
		e.preventDefault();
		$.ajax({
        	url: "controll-user.php?<?php echo md5('resetPassword')?>",
			type: "POST",
