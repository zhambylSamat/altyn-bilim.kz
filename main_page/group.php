		...
		<div class='row'>
			<div class='col-md-12 col-sm-12'>
				<ul class="nav nav-tabs">
				 	...
				 	<li role="presentation" class='navigation' data='mark'><a href="#">Баға қою</a></li>
				</ul>
				<br>
			</div>
		</div>
					...
					<table class='table table-striped table-bordered'>
						...
						<tr>
							<td colspan='4'>
								...
								?>
									<tr id='<?php echo $count;?>_tr' class='head-student <?php echo ($value['c']!=0 && $subject_num!='S5985a7ea3d0ae721486338') ? "warning" : "";?>' style='border:1px solid lightgray; border-bottom:none; cursor: pointer;'>
										<!-- <div class='row'> -->
											<td>
		...
		$.ajax({
			...
			success: function(dataS){
		    	...
		    	if(data.success){
		    		...
		    		$elem.load("load_ajax_trial_test_mark.php?data_num="+$data_num+"&sjn="+$sjn,  function( response, status, xhr ){
		    			if(status=="error"){
		    				$elem.parent().stop();
